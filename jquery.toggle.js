$(function() {
    ...
    $('nav li,nav > ul > li> a[href^=#]').on('click', function () {
        (window.innerWidth ? window.innerWidth : $(window).width()) <= 768 && (
    ...
    $("nav a").on("click", function() {
        (window.innerWidth ? window.innerWidth : $(window).width()) <= 768 && $("#open").click()
    });
    ...
    $(window).resize(function() {
        ...
        w > 768 && menu.is(":hidden") && menu.attr("style", ""),
        w > 768 && sub.is(":hidden") && sub.attr("style", "")
    });
